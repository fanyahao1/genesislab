"""Configuration for Booster K1 velocity tracking task on flat terrain."""
...
@configclass
class BoosterK1FlatEnvCfg(BoosterK1RoughEnvCfg):
    """Configuration for Booster K1 velocity tracking on flat terrain."""
...
@configclass
class BoosterK1FlatEnvCfg_PLAY(BoosterK1FlatEnvCfg):
    """Configuration for Booster K1 velocity tracking on flat terrain (play mode)."""
