"""Configuration for Booster K1 velocity tracking task on rough terrain."""
...
@configclass
class BoosterK1RoughEnvCfg(BaseVelocityEnvCfg):
    """Configuration for Booster K1 velocity tracking on rough terrain."""
    ...
    def __post_init__(self):
        ...
        # Actions: align with genesis-forge style (K1 has multiple actuator groups)
...
class BoosterK1RoughEnvCfg_PLAY(BoosterK1RoughEnvCfg):
    """Configuration for Booster K1 velocity tracking on rough terrain (play mode)."""
