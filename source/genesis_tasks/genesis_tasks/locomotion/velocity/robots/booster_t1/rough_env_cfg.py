"""Configuration for Booster T1 velocity tracking task on rough terrain."""
...
class BoosterT1RoughEnvCfg(BaseVelocityEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robots["robot"] = BOOSTER_T1_CFG
        ...
        # Actions: align with genesis-forge style (T1 has multiple actuator groups)
...
class BoosterT1RoughEnvCfg_PLAY(BoosterT1RoughEnvCfg):
    """Configuration for Booster T1 velocity tracking on rough terrain (play mode)."""
