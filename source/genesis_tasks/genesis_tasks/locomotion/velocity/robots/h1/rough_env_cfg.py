"""Configuration for Unitree H1 velocity tracking task on rough terrain."""

from genesislab.managers import SceneEntityCfg
from genesislab.utils.configclass import configclass

from ...base_velocity_env_cfg import BaseVelocityEnvCfg
from genesis_assets.robots import UNITREE_H1_CFG
import genesis_tasks.locomotion.velocity.mdp as mdp


@configclass
class UnitreeH1RoughEnvCfg(BaseVelocityEnvCfg):
    """Configuration for Unitree H1 velocity tracking on rough terrain."""

    def __post_init__(self):
        # Post init of parent
        super().__post_init__()

        self.scene.robots["robot"] = UNITREE_H1_CFG
        ...
        # Actions: align with genesis-forge style (H1 has multiple actuator groups)
...
class UnitreeH1RoughEnvCfg_PLAY(UnitreeH1RoughEnvCfg):
    """Configuration for Unitree H1 velocity tracking on rough terrain (play mode)."""
