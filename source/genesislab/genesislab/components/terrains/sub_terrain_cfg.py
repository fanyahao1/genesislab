...
class FlatPatchSamplingCfg:
    ...
    Please check the function :meth:`~genesislab.components.terrains.utils.find_flat_patches` for more details.
    """
...
class SubTerrainBaseCfg:
    ...
    In case the :class:`~genesislab.components.terrains.terrain_importer_cfg.TerrainImporterCfg` is used, this
    parameter gets overridden by :attr:`genesislab.components.terrains.terrain_importer_cfg.TerrainImporterCfg.size`
    attribute.
    """
