...
inherit from a compatible terrain config and define the following attributes:
...
class TerrainGeneratorCfg:
    ...
    cache_dir: str = "/tmp/genesislab/terrains"
    """The directory where the terrain cache is stored. Defaults to "/tmp/genesislab/terrains"."""
